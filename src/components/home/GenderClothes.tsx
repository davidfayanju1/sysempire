        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-[1070px] mx-auto">
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1664004475514-a50f6c4cee31?q=80&w=985&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
              }}
            />
            {/* Dark Overlay */}
            <div className="absolute inset-0 bg-black/50 group-hover:bg-black/40 transition-colors duration-300" />
